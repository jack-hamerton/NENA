...
export default function PodcastsPage() {
  ...
  const filteredPodcasts = trending.filter(p => 
    ...
    (p.author ? p.author.toLowerCase().includes(searchQuery.toLowerCase()) : false)
  );

  if (isLoading) {
    return (
      <div className="flex-1 flex items-center justify-center bg-background min-h-[calc(100vh-3.5rem)]">
      ...
      <div className="p-8 border-b bg-gradient-to-r from-primary/10 via-transparent to-transparent flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-black italic tracking-tighter uppercase">Podcast Hub</h1>
          </div>
