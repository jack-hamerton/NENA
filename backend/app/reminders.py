...
async def send_event_reminders():
    ...
    # Skip event reminders if event crud module is not available
    try:
        if hasattr(crud, 'event') and hasattr(crud.event, 'get_events_starting_soon'):
        ...
        # Log error but continue - event reminders are optional
        pass
    db.close()
